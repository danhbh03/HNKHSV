...
<body>
                ...
                <div class="col-lg-7 offset-lg-4">
                    <div class="banner__item">
                        ...
                        <div class="banner__item__text">
                            <h2>Bộ Suit</h2>
                            <a href="/shop?filter=Bộ+Suit">Mua ngay</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
    ...
    <section class="product spad">
        <div class="container">
            ...
            <?php
                function renderProducts($products, $label, $filterClass, $itemsPerPage) {
                    $max = min($itemsPerPage, count($products));
                    for ($i = 0; $i < $max; $i++): ?>
                        <div class="col-lg-3 col-md-6 col-sm-6 mix <?= $filterClass ?>">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="img/product/<?= htmlspecialchars($products[$i]['Image']) ?>">
            ...
            <div class="row product__filter">
                <?php renderProducts($BestSeller, 'Best Sellers', 'best-sellers', $itemsPerPage); ?>
                <?php renderProducts($NewArrival, 'New Arrivals', 'new-arrivals', $itemsPerPage); ?>
                <?php renderProducts($HotSale, 'Hot Sale', 'hot-sales', $itemsPerPage); ?>
            </div>
